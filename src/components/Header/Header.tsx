  ...
  return (
    <header className='w-full'>
      <div className='mt-0 pr-6 bg-[linear-gradient(-180deg,#f53d2d,#f63)]'>
        <div className='py-2 flex justify-end gap-9'>
          <Floating
            style='flex justify-end items-center text-white hover:text-gray-300 cursor-pointer'
            Children={
              <>
                <ul className='mt-1 px-3 pt-1'>
                  <li className='pb-2 m-0 hover:text-orange cursor-pointer'>Tiếng Việt</li>
                  <li className='pb-2 hover:text-orange cursor-pointer'>English</li>
                </ul>
              </>
            }
            referenceElement={
      ...
      <div className='px-20 py-5 bg-[linear-gradient(#ee4d2d,#ff7337)]'>
        <div className='grid grid-cols-12'>
          <div onClick={() => navigate('/')} className='cursor-pointer py-2 px-2 col-span-2'>
          ...
          <Floating
            style='col-span-1 flex items-center justify-center'
            Children={
              <>
                ...
                <div className='my-3'>
                  <div className='pb-5 flex justify-between items-center px-3 '>
                    <div className='text-xs'>1 Thêm Hàng Vào Giỏ</div>
                    <button
              ...
              <>
                <div className='cursor-pointer relative'>
                  ...
                  <div className='absolute top-0 left-2 transform translate-x-1/2 -translate-y-1/2'>
                    <div className='w-8 p-0  bg-white p-1 rounded-xl text-center w-fit text-orange bg-white'>12</div>
                  </div>
                </div>
              </>
            }
